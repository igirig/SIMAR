@extends('layouts.main', ['activePage' => 'transportistas.create', 'titlePage' => 'Transportistas'])
@section('scripts')
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('transportistas.store') }}" method="post" class="form-horizontal">
                        @csrf
                        <div class="card">
                            <div class="card-header card-header-warning">
                                <h4 class="card-title">Nuevo transportista</h4>
                                <p class="card-category">Ingrese los datos del transportista...</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="razonSocial"
                                            placeholder="Ingrese la razón social del transportista" value="{{ old('razonSocial') }}"
                                            onkeyup="this.value = this.value.toUpperCase();" maxlength="64" autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="noRegistroAmbiental"
                                            placeholder="Ingrese el número de registro ambiental del transportista"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="calle"
                                            placeholder="Ingrese la calle donde esta ubicado el transportista" value="{{ old('calle') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="noExterior"
                                            placeholder="Ingrese el número exterior donde esta ubicado el transportista en caso de tener (*)"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="noInterior"
                                            placeholder="Ingrese el número interior donde esta ubicado el transportista en caso de tener (*)"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="colonia"
                                            placeholder="Ingrese la colonia donde esta ubicado el transportista"
                                            value="{{ old('colonia') }}"
                                            onkeyup="this.value = this.value.toUpperCase();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="codigoPostal"
                                            placeholder="Ingrese el código postal del transportista"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="tel" class="form-control" name="telefono"
                                            placeholder="Ingrese el teléfono del transportista"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="tel" class="form-control" name="extension"
                                            placeholder="Ingrese la extensión del transportista en caso de tener (*)" value="{{ old('extension') }}"
                                            maxlength="6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control" name="correo"
                                            placeholder="Ingrese el correo electrónico de contacto del transportista" value="{{ old('correo') }}"
                                            onkeyup="this.value = this.value.toLowerCase();" maxlength="64">
