                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="noInterior"
                                            value="{{ old('noInterior', $estacion->noInterior) }}" maxlength="16"
                                            onkeyup="this.value = this.value.toUpperCase();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="codigoPostal"
                                            value="{{ old('codigoPostal', $estacion->codigoPostal) }}" maxlength="5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="tel" class="form-control" name="telefono"
                                            value="{{ old('telefono', $estacion->telefono) }}" maxlength="10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="tel" class="form-control" name="extension"
                                            value="{{ old('extension', $estacion->extension) }}" maxlength="6">
