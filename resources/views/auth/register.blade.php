@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('SIAPA')])
                ...
                <form class="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="card card-login card-hidden mb-3">
                        <div class="card-header card-header-success text-center">
                            <h3 class="card-title"><strong>{{ __('Registrar usuario') }}</strong></h3>
                            <img src="{{ asset('img/logoSimar2.png') }}" alt="Grupo Simar" height="50px" width="50px">
                        </div>
                        <div class="card-body ">
                            <p class="card-description text-center">{{ __('Ingrese tus datos:') }}</p>
                            ...
                            {{-- <div class="form-check mr-auto ml-3 mt-3">
                                <label class="form-check-label">
                                    ...
                                    {{ __('I agree with the ') }} <a style="color: lightgreen" href="#">{{ __('Privacy Policy') }}</a>
                                </label>
                            </div> --}}
                        ...
                        <div class="card-footer justify-content-center">
                            <button type="submit"
                                class="btn btn-success btn-link btn-lg">{{ __('Registrar usuario') }}</button>
                        </div>
                    </div>
                </form>
            </div>
